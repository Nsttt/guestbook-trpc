          ...
          {session ? (
            <div>
              <div className="flex flex-row justify-between">
                <p className="self-center">Hello {session.user?.name} ❤️</p>
                <button
                  className="p-2 rounded-md border-2 border-red-800 focus:outline-none"
                  onClick={() => signOut()}
                >
                  Logout
                </button>
            ...
            <div>
              <button
                className="p-2 rounded-md border-2 border-blue-800 focus:outline-none"
